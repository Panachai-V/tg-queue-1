        ...
        <div class="section-header" data-aos="fade-up" data-aos-delay="0">
          ...
          <div class="header-wrapper">
            <div class="text-container">
              <h6 class="h3">Companies</h6>
            </div>
            <div class="btns hide-mobile">
              <Button 
                text="เพิ่ม" href="/admin/company-add" 
    ...
    for(var i=0; i<8; i++){
      if(i<2){
        this.rows1.push({
          ...
          company: { text: 'บริษัท พีอาร์เดริเวรี่ จำกัด' },
          ...
          options: {
            type: 'options',
            view: { type: 'link', href: '/admin/company-view' },
            edit: { type: 'link', href: '/admin/company-edit' }
          }
        });
      }else{
        this.rows1.push({
