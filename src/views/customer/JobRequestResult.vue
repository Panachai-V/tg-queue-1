  ...
  <section class="section-full">
    <div class="container">
      ...
      <div class="section-header mb-4" data-aos="fade-up" data-aos-delay="0">
        <div class="btns mt-0">
          <a href="/customer/job-requests/2" class="btn color-gray h-color-01">
      ...
      <div class="section-px pt-2 pb-6" data-aos="fade-up" data-aos-delay="150">
        <form v-if="!dataCommentValid" action="/" method="GET" @submit="onSubmitComment">
          <div class="grids">
            <div class="grid md-1-3 sm-50 xs-50 mt-4">
              <FormGroup 
                type="select" label="ระดับความพอใจ *" placeholder="เลือกระดับความพอใจ" :required="true" 
                :options="[
      ...
      <div class="section-px section-py-grid" data-aos="fade-up" data-aos-delay="150">
        <div class="grids">
          ...
          <div class="grid xl-1-3 lg-40 md-50 sm-80">
            <FormGroup type="plain" label="วันที่รับสินค้า" :value="dataset.pickupDate" />
          </div>
          <div class="sep"></div>
