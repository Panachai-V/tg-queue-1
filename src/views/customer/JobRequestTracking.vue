  ...
  <section class="section-full">
    <div class="container">
      ...
      <div class="section-header mb-4" data-aos="fade-up" data-aos-delay="0">
        <div class="btns mt-0">
          <a href="/customer/job-requests/1" class="btn color-gray h-color-01">
      ...
      <div class="section-px section-py-grid" data-aos="fade-up" data-aos-delay="150">
        <div v-if="!dataset.confPickupDate || !dataset.confPickupTime || !dataset.qrCode">
          <h6 class="h5 color-danger mt-6" @click="generateMockData">
            รอการตอบรับจากผู้ดูแลระบบ
          </h6>
        </div>
...
export default {
  ...
  methods: {
    ...
    generateMockData() {
      ...
      this.dataset.confPickupDate = new Date();
      this.dataset.confPickupTime = '09.45';
